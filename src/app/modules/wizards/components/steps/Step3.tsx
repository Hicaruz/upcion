  ...
  return (
    <div className='w-100'>
      ...
      <div className='fv-row mb-10'>
        <div className='row'>
          <div className='col-md-6 col-sm-12'>
            ...
            <Field name='fisrt_last_name' className='form-control form-control-lg form-control-solid' />
            <div className='text-danger mt-2'>
              <ErrorMessage name='fisrt_last_name' />
            </div>
          </div>
          <div className='col-md-6 col-sm-12'>
            <label className='form-label required'>Segundo Apellido</label>

            <Field name='second_last_name' className='form-control form-control-lg form-control-solid' />
            <div className='text-danger mt-2'>
      ...
      <div className='fv-row mb-10'>
        <div className='row'>
          ...
          <div className='col-md-6 col-sm-12'>
            ...
            <Field name='second_name' className='form-control form-control-lg form-control-solid' />
            <div className='text-danger mt-2'>
      ...
      <div className='fv-row mb-10'>
        <div className='row'>
          <div className='col-md-6 col-sm-12'>
            ...
            <Field type="date" name='born_date' className='form-control form-control-lg form-control-solid' />
            <div className='text-danger mt-2'>
              <ErrorMessage name='born_date' />
            </div>
          </div>
          <div className='col-md-6 col-sm-12'>
            <label className='form-label required'>DPI</label>

            <Field name='personal_document' className='form-control form-control-lg form-control-solid' />
            <div className='text-danger mt-2'>
              <ErrorMessage name='personal_document' />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='fv-row mb-10'>
        <div className='row'>
          <div className='col-md-6 col-sm-12'>
            <label className='form-label required'>Telefono (linea ficha)</label>

            <Field name='home_phone' className='form-control form-control-lg form-control-solid' />
            <div className='text-danger mt-2'>
          ...
          <div className='col-md-6 col-sm-12'>
            ...
            <Field name='mobile_phone' className='form-control form-control-lg form-control-solid' />
            <div className='text-danger mt-2'>
